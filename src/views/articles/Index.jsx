    ...
    <div className='sm:px-8 mt-16 sm:mt-32'>
      <Container>
        ...
        <div className="mt-16 sm:mt-20">
          <div className="md:border-l md:dark:border-zinc-700/40 md:pl-6">
                  ...
                  <article className='md:grid md:grid-cols-4 md:items-baseline' key={i}>
                    <div className='md:col-span-3 group relative flex flex-col items-start'>
                      <h2 className='text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100'>
                        <div className="absolute -inset-y-6 -inset-x-4 z-0 scale-95 bg-zinc-50 dark:bg-zinc-800/50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl"></div>
                      ...
                      <time className='md:hidden relative z-10 order-first mb-3 flex items-center text-sm to-zinc-400 dark:text-zinc-500 pl-3.5' dateTime={item.dateTime}>
                        <span className='absolute inset-y-0 left-0 flex items-center'>
                          <span className='h-4 w-0.5 rounded-full bg-zinc-500'></span>
                        </span>
                        {item.time}
                      </time>
                      <p className='relative z-10 mt-2 text-sm to-zinc-600 dark:text-zinc-400'>
                        {item.inti}
                      </p>
